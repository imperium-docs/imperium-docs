    ...
    <>
      <aside className="sticky top-0 hidden w-96 flex-col gap-6 self-start sm:flex">
        <article className="my-6 flex justify-between gap-4">
          <div
            className="relative flex cursor-default items-center gap-2 rounded-xl p-3 font-bold uppercase text-white/80 hover:bg-white/10"
          ...
          >
            ...
            <div
              className="absolute top-full z-10 rounded-2xl border border-white/20 bg-black/60 text-white backdrop-blur glass-panel"
              style={{
                left: "calc(50% - 150px)",
                width: 300,
            ...
            >
              ...
              <button className="flex w-full items-center gap-3 border-t border-white/20 bg-white/10 px-5 py-3 text-left font-bold">
                <Flag language={language} width={45} />
                <span className="text-blue-500">{language.name}</span>
              </button>
              <Link
                className="flex w-full items-center gap-3 rounded-b-2xl border-t border-white/20 px-5 py-3 text-left font-bold hover:bg-white/10"
                href="/register"
              >
          ...
          <span
            className="relative flex items-center gap-2 rounded-xl p-3 font-bold text-white hover:bg-white/10"
          ...
          >
            ...
            <div
              className="absolute top-full z-10 flex flex-col gap-5 rounded-2xl border border-white/20 bg-black/60 p-5 text-white backdrop-blur glass-panel"
              style={{
                left: "calc(50% - 200px)",
                width: 400,
          ...
          >
            ...
            <div
              className="absolute top-full z-10 flex w-72 items-center gap-3 rounded-2xl border border-white/20 bg-black/60 p-5 text-white backdrop-blur glass-panel"
              style={{
                left: "calc(50% - 150px)",
...
const UnlockLeaderboardsSection = () => {
  ...
  return (
    <article className="glass-card flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-white">
...
const DailyQuestsSection = () => {
  ...
  return (
    <article className="glass-card flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-white">
