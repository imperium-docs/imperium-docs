...
export const LeftBar = ({ selectedTab }: { selectedTab: Tab | null }) => {
  ...
  return (
    <>
      <nav
        className={[
          "fixed bottom-0 left-0 top-0 hidden flex-col gap-5 p-3 md:flex lg:p-5 glass-panel",
      ...
      >
        ...
        <ul className="flex flex-col items-stretch gap-3">
              ...
              <li key={item.href} className="flex flex-1">
                {item.name === selectedTab ? (
                  <Link
                    href={item.href}
                    className={[
                      "flex grow items-center gap-3 rounded-xl border-2 border-[#84d8ff] bg-[#ddf4ff] px-2 py-1 text-sm font-bold uppercase text-white",
                  ...
                  <Link
                    href={item.href}
                    className={[
                      "flex grow items-center gap-3 rounded-xl px-2 py-1 text-sm font-bold uppercase text-white/70 hover:bg-white/10",
                      isCollapsed ? "justify-center px-0" : "",
                    ].join(" ")}
                  >
                    {item.icon}{" "}
          ...
          <div
            className={[
              "relative flex grow cursor-default items-center gap-3 rounded-xl px-2 py-1 font-bold uppercase text-white/70 hover:bg-white/10",
              isCollapsed ? "justify-center px-0" : "",
            ].join(" ")}
          ...
          >
            ...
            <div
              className={[
                "absolute left-full top-[-10px] min-w-[300px] rounded-2xl border-2 border-white/20 bg-black/60 text-left text-white/80 backdrop-blur",
